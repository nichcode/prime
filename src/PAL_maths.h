...
PAL_Mat4 _Ortho(f32 left, f32 right, f32 bottom, f32 top, f32 near_clip, f32 far_clip)
{
...
PAL_Mat4 _Perspective(f32 fov_radians, f32 aspect_ratio, f32 near_clip, f32 far_clip)
{
...
PAL_Mat4 _Translate(const PAL_Vec3& translation)
{
    PAL_Mat4 matrix = _Identity();
...
PAL_Mat4 _Scale(const PAL_Vec3& scale)
{
    PAL_Mat4 matrix = _Identity();
...
PAL_Mat4 _RotateZ(f32 angle_degrees)
{
    PAL_Mat4 matrix = _Identity();
    f32 angle_radians = _ToRadians(angle_degrees);
...
PAL_Mat4 _Inverse(const PAL_Mat4& matrix)
{
