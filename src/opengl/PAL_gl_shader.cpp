...
inline u32 dataTypeSize(u32 type)
{
    switch (type)
    {
        case PAL_ShaderDataTypes_Int:
        case PAL_ShaderDataTypes_Float: {
            return 4;
        }

        case PAL_ShaderDataTypes_Int2:
        case PAL_ShaderDataTypes_Float2: {
            return 8;
        }

        case PAL_ShaderDataTypes_Int3:
        case PAL_ShaderDataTypes_Float3: {
            return 12;
        }

        case PAL_ShaderDataTypes_Int4:
        case PAL_ShaderDataTypes_Float4: {
            return 16;
        }
    }
    return 0;
