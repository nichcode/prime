...
void _WGLCreateDummyContext()
{
    ...
    PR_ASSERT(wglChoosePixelFormatARB, "failed to load wglChoosePixelFormatARB");
    
    wglCreateContextAttribsARB = (PFNWGLCREATECONTEXTATTRIBSARBPROC)LOAD_WGL_FUNC("wglCreateContextAttribsARB");
    PR_ASSERT(wglCreateContextAttribsARB, "failed to load wglCreateContextAttribs ARB");
    
    wglSwapIntervalEXT = (PFNWGLSWAPINTERVALEXTPROC)LOAD_WGL_FUNC("wglSwapIntervalEXT");
    PR_ASSERT(wglSwapIntervalEXT, "failed to load wglSwapIntervalEXT");
